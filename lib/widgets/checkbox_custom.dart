...
///  * [Switch], a widget with semantics similar to [CheckboxCustom].
...
class _CheckboxCustomState extends State<CheckboxCustom> with TickerProviderStateMixin {
  @override
...
const double _kEdgeSize = CheckboxCustom.width;
