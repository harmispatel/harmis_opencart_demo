...
class MyCustomDialog extends StatelessWidget {
  ...
  /// The background color of the surface of this [MyCustomDialog].
  ///
  /// This sets the [Material.color] on this [MyCustomDialog]'s [Material].
  ///
  ...
  /// The z-coordinate of this [MyCustomDialog].
  ///
...
///  * [MyCustomDialog], on which [AlertDialog] and [SimpleDialog] are based.
...
///  * [MyCustomDialog], on which [SimpleDialog] and [AlertDialog] are based.
///  * [showDialog], which actually displays the dialog and returns its result.
///  * <https://material.io/design/components/dialogs.html#simple-dialog>
...
///
/// This function takes a `builder` which typically builds a [MyCustomDialog] widget.
