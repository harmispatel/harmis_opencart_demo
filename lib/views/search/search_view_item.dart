...
class SearchItem extends StatelessWidget {
  ...
  SearchItem({this.item, this.productTap, this.addToCartTap});
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: productTap,
      child: Container(
          padding: EdgeInsets.only(left: 6.0, right: 6.0, top: 10.0, bottom: 10.0),
          margin: EdgeInsets.only(left: 8, right: 5, top: 4, bottom: 4),
                      ...
                      children: <Widget>[
                        Flexible(
                          ...
                          child: Container(
                            ...
                            height: 50, //mediaQueryData.size.height / 3.3,
                            width: 50.0,
                            decoration: BoxDecoration(
